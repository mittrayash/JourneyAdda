...
$id=$_GET["id"];
$_SESSION["id"]=$_GET["id"];
$query1="select * from index_details where id='$id'";
        ...
        <section class="content">
          ...
          <div class="row">
            <div class="col-lg-12 ">
		     ...
		     <form action='editindex_details.php' method='post' enctype="multipart/form-data" >
...
<form action='editindex_details.php' method='post' enctype="multipart/form-data" >
    <p><label>F/R Time</label><br />
    <input type="text" name='fr' class="form-control" placeholder="enter as 09:00 P.M." value="<?php echo $fr_time;?>" ></p>

    <p><label>S/R Time</label><br />
    <input type="text" name='sr' class="form-control" placeholder="enter as 10:00 P.M." value="<?php echo $sr_time;?>"></p>
...
<p><label>Message</label><br />
    <input type="text" name='message' class="form-control" value="<?php echo $message;?>"></p>
