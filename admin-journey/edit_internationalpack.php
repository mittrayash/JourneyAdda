...
$e_id=$_GET["e_id"];
  ...
  $query="select* from discover_country where id='$e_id'";
...
<div class=" col-md-12"> 
      <!--FORM -->
<form name="testimonials" id="testimonials" enctype="multipart/form-data"  action="update_inter.php" method="post" style="margin-top:3%;">
