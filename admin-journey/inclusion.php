...
$query="select * from inclusions ORDER BY id ASC LIMIT $start_from, $limit";
...
$data="INSERT INTO inclusions values('','$target_file1','$target_file2','$target_file3','$about1','$about2','$about3','$package')"; 
...
?>
 ...
 <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
  ...
  <ul class="nav nav-pills">
    ...
    <li class="active"><a href="inclusion.php">Inclusion/Exclusions</a></li>
    <li><a href="destination.php">Destination Info</a></li>
  </ul>
</div>
<div class="col-md-12">
               <form name="image" action="inclusion.php" method="post" enctype="multipart/form-data">
...
?>
         <tbody>
            <tr>
              ...
              <td>
              <a href="edit_inclusion.php?e_id=<?php echo $id;?>"><button class="btn btn-info" style="margin-bottom:4px;">Edit</button></a>
<a href="delete_inclusion.php?d_id=<?php echo $id?>"><button  class="btn btn-danger">Delete</button></a>
</td>
           </tr>
...
<?php }?>
       ...
       <?php  
$sql = "SELECT COUNT(id) FROM inclusion";  
...
for ($i=1; $i<=$total_pages; $i++) {  
             $pagLink .= "<li><a href='inclusion.php?page=".$i."'>".$i."</a></li>";  
};  
echo $pagLink . "</ul></nav>";  
?>
...
$('.pagination').pagination({
		...
		hrefTextPrefix : 'inclusion.php?page='
    });
	});
	</script>
