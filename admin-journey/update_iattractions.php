...
$name=$_POST["package"];
    ...
    $query=mysqli_query($conn, "select * from international_attractions where id='$e_id'")or die(mysqli_error());
...
$sql="UPDATE international_attractions SET image1='$fileupload2',image2='$fileupload3',image3='$fileupload4',detail1='$about1',detail2='$about2',detail3='$about3',package_name='$name' where id='$e_id'";
