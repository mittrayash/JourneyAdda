...
$query="select * from attractions ORDER BY id ASC LIMIT $start_from, $limit";
...
$data="INSERT INTO attractions values('','$target_file1','$target_file2','$target_file3','$about1','$about2','$about3','$package')"; 
...
?>
 ...
 <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <div class="col-md-12 member">
              <div class="form-group pb20 col-md-4"><h3 style="margin-left:6%;">Attractions</h3></div><div class="container col-md-8" style="margin-top:1%;">
  ...
  <ul class="nav nav-pills">
    ...
    <li><a href="destination.php">Destination Info</a></li>
  </ul>
</div>
 
</div>
<div class="col-md-12">
               <form name="image" action="attractions.php" method="post" enctype="multipart/form-data">
...
?>
         <tbody>
            <tr>
              ...
              <td>
              <a href="edit_attraction.php?e_id=<?php echo $id;?>"><button class="btn btn-info" style="margin-bottom:4px;">Edit</button></a>
<a href="delete_attraction.php?d_id=<?php echo $id?>"><button  class="btn btn-danger">Delete</button></a>
</td>
           </tr>
...
<?php }?>
       ...
       <?php  
$sql = "SELECT COUNT(id) FROM attractions";  
...
for ($i=1; $i<=$total_pages; $i++) {  
             $pagLink .= "<li><a href='attractions.php?page=".$i."'>".$i."</a></li>";  
};  
echo $pagLink . "</ul></nav>";  
?>
...
$('.pagination').pagination({
		...
		hrefTextPrefix : 'attractions.php?page='
    });
	});
	</script>
