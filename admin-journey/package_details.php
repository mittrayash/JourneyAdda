...
include("package_detail_insert.php");
$limit=8;  
...
$query="select * from package_details ORDER BY id ASC LIMIT $start_from, $limit";
        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <div class="col-md-12 member">
              <div class="form-group pb20 col-md-4"><h3 style="margin-left:6%;">Package Details</h3></div><div class="container col-md-8" style="margin-top:1%;">
  
  <ul class="nav nav-pills">
    <li class="active" id="package"><a href="package_details.php">Package Details</a></li>
...
<div class="col-md-12">
               <form name="image" action="package_details.php" method="post" enctype="multipart/form-data">
       ...
       <h2 style="text-align:center;margin-top:6%;margin-bottom:2%;">Edit Package Details</h2>
...
?>
         <tbody>
            <tr>
              ...
              <a href="edit_package_details.php?e_id=<?php echo $id;?>"><button class="btn btn-info" style="margin-bottom:4px;">Edit</button></a>
<a href="delete_package_details.php?d_id=<?php echo $id?>"><button  class="btn btn-danger">Delete</button></a>
</td>
           </tr>
