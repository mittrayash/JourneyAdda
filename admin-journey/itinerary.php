...
$query="select * from itinerary ORDER BY id ASC LIMIT $start_from, $limit";
...
$data="INSERT INTO itinerary values('','$target_file1','$target_file2','$target_file3','$about1','$about2','$about3','$package')"; 
...
<div class="col-md-12">
               <form name="image" action="itinerary.php" method="post" enctype="multipart/form-data">
...
<?php }?>
       ...
       <?php  
$sql = "SELECT COUNT(id) FROM itinerary";  
...
for ($i=1; $i<=$total_pages; $i++) {  
             $pagLink .= "<li><a href='itinerary.php?page=".$i."'>".$i."</a></li>";  
};  
echo $pagLink . "</ul></nav>";  
?>
...
$('.pagination').pagination({
		...
		hrefTextPrefix : 'itinerary.php?page='
    });
	});
	</script>
