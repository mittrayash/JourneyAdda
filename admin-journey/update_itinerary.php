...
$sql="UPDATE itinerary SET image1='$fileupload2',image2='$fileupload3',image3='$fileupload4',detail1='$about1',detail2='$about2',detail3='$about3',package_name='$name' where id='$e_id'";
