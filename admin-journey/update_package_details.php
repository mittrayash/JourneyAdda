...
$name=$_POST["name"];
    ...
    $query=mysqli_query($conn, "select * from package_details where id='$e_id'")or die(mysqli_error());
 ...
 $sql="UPDATE package_details SET image1='$fileupload2',image2='$fileupload3',image3='$fileupload4',place1='$place1',experience1='$experience1',experience2='$experience2',experience3='$experience3',experience4='$experience4',experience5='$experience5',package_name='$name' where id='$e_id'";
