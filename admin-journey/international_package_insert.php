...
if(count($errors) == 0) {
$data="INSERT INTO international_package_details values('','$place','$experience','$experience1','$experience2','$experience3','$experience4','$target_file1','$target_file2','$target_file3','$name')"; 
