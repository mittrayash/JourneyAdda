        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <div class="col-md-12 member" style="">
              <div class="pb20 col-md-12"><h2 style="text-align:center;">International Holidays Package</h2></div>
               <form name="image" action="discover_country_package.php" method="post" enctype="multipart/form-data">
              ...
              <textarea class="form-control" name="about" rows="6" placeholder="Details About the country" required></textarea>
                 </div>
                 <div class="form-group col-md-12" style="text-align:center;"><input type="submit" class="btn btn-info" value="Submit" name="submit" ></div>
                </form>
       </div>
       <h2 style="text-align:center;margin-top:3%;margin-bottom:2%;">Edit International Holidays Package</h2>
...
?>
         <tbody>
            <tr>
              ...
              <a href="edit_interpackage.php?e_id=<?php echo $id;?>"><button class="btn btn-info" style="margin-bottom:4px;">Edit</button></a>
<a href="delete_interpackage.php?d_id=<?php echo $id?>"><button  class="btn btn-danger">Delete</button></a>
</td>
           </tr>
