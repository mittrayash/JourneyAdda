...
$query="select * from international_attractions ORDER BY id ASC LIMIT $start_from, $limit";
...
$data="INSERT INTO international_attractions values('','$target_file1','$target_file2','$target_file3','$about1','$about2','$about3','$package')"; 
        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <div class="col-md-12 member">
              <div class="form-group pb20 col-md-4"><h3 style="margin-left:6%;">International Attractions</h3></div><div class="container col-md-8" style="margin-top:1%;">
  
  <ul class="nav nav-pills">
    <li id="package"><a href="package_details.php">Package Details</a></li>
    <li ><a href="international_itinerary.php">Itinerary</a></li>
    <li class="active"><a href="international_attractions.php">Attractions</a></li>
...
<div class="col-md-12">
               <form name="image" action="international_attractions.php" method="post" enctype="multipart/form-data">
       ...
       <h2 style="text-align:center;margin-top:3%;margin-bottom:2%;">Edit Attraction</h2>
...
?>
         <tbody>
            <tr>
              ...
              <td>
              <a href="edit_iattraction.php?e_id=<?php echo $id;?>"><button class="btn btn-info" style="margin-bottom:4px;">Edit</button></a>
<a href="delete_iattraction.php?d_id=<?php echo $id?>"><button  class="btn btn-danger">Delete</button></a>
</td>
           </tr>
...
<?php }?>
       ...
       <?php  
$sql = "SELECT COUNT(id) FROM international_attractions";  
...
for ($i=1; $i<=$total_pages; $i++) {  
             $pagLink .= "<li><a href='international_attractions.php?page=".$i."'>".$i."</a></li>";  
};  
echo $pagLink . "</ul></nav>";  
?>
...
$('.pagination').pagination({
		...
		hrefTextPrefix : 'international_attractions.php?page='
    });
	});
	</script>
