...
$query="select * from international_destination ORDER BY id ASC LIMIT $start_from, $limit";
...
$data="INSERT INTO international_destination values('','$target_file1','$target_file2','$target_file3','$about1','$about2','$about3','$package')"; 
...
?>
 ...
 <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <div class="col-md-12 member">
              <div class="form-group pb20 col-md-4"><h3 style="margin-left:6%;">International Destination</h3></div><div class="container col-md-8" style="margin-top:1%;">
  ...
  <ul class="nav nav-pills">
    ...
    <li class="active"><a href="international_destination.php">Destination Info</a></li>
  </ul>
</div>
<div class="col-md-12">
               <form name="image" action="international_destination.php" method="post" enctype="multipart/form-data">
       ...
       <h2 style="text-align:center;margin-top:3%;margin-bottom:2%;">Edit International Destination</h2>
...
?>
         <tbody>
            <tr>
              ...
              <td>
              <a href="edit_idestination.php?e_id=<?php echo $id;?>"><button class="btn btn-info" style="margin-bottom:4px;">Edit</button></a>
<a href="delete_idestination.php?d_id=<?php echo $id?>"><button  class="btn btn-danger">Delete</button></a>
</td>
           </tr>
...
<?php }?>
       ...
       <?php  
$sql = "SELECT COUNT(id) FROM international_destination";  
...
for ($i=1; $i<=$total_pages; $i++) {  
             $pagLink .= "<li><a href='international_destination.php?page=".$i."'>".$i."</a></li>";  
};  
echo $pagLink . "</ul></nav>";  
?>
...
$('.pagination').pagination({
		...
		hrefTextPrefix : 'international_destination.php?page='
    });
	});
	</script>
