...
$package4=$_POST["package4"];
       ...
       $query=mysqli_query($conn, "select * from discover_country where id='$e_id'")or die(mysqli_error());
	...
	$fileupload2 = $row['image'];
       ...
       if(!empty($_FILES["fileupload1"]["name"]))
	    ...
	    $query1="UPDATE discover_country SET image='$fileupload2',country='$city',about_country='$about',package1='$package',package2='$package1',package3='$package2',package4='$package3',package5='$package4' where id=$e_id";
