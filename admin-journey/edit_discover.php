...
$e_id=$_GET["e_id"];
  ...
  $query="select* from discover_india where id='$e_id'";
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row">
           ...
           <h2 style="text-align:center; margin-top:4%;">Edit Discover India</h2>
<div class=" col-md-12"> 
      <!--FORM -->
<form name="testimonials" id="testimonials" enctype="multipart/form-data"  action="update_discover.php" method="post" style="margin-top:3%;">
    ...
    <div class="col-md-3" style="margin-bottom:6%;"><input type="text" name="city" class="form-control" placeholder="enter city name.."  value="<?php echo $city;?>" required/></div>
