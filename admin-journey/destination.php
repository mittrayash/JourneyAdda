...
$query="select * from destination ORDER BY id ASC LIMIT $start_from, $limit";
...
$data="INSERT INTO destination values('','$target_file1','$target_file2','$target_file3','$about1','$about2','$about3','$package')"; 
        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <div class="col-md-12 member">
              <div class="form-group pb20 col-md-4"><h3 style="margin-left:6%;">Destination</h3></div><div class="container col-md-8" style="margin-top:1%;">
  
  <ul class="nav nav-pills">
    <li id="package"><a href="package_details.php">Package Details</a></li>
    <li ><a href="itinerary.php">Itinerary</a></li>
    <li><a href="attractions.php">Attractions</a></li>
    <li ><a href="inclusion.php">Inclusion/Exclusions</a></li>
    <li class="active"><a href="destination.php">Destination Info</a></li>
  </ul>
</div>
<div class="col-md-12">
               <form name="image" action="destination.php" method="post" enctype="multipart/form-data">
       ...
       <h2 style="text-align:center;margin-top:3%;margin-bottom:2%;">Edit Destination</h2>
...
?>
         <tbody>
            <tr>
              ...
              <td>
              <a href="edit_destination.php?e_id=<?php echo $id;?>"><button class="btn btn-info" style="margin-bottom:4px;">Edit</button></a>
<a href="delete_destination.php?d_id=<?php echo $id?>"><button  class="btn btn-danger">Delete</button></a>
</td>
           </tr>
...
<?php }?>
       ...
       <?php  
$sql = "SELECT COUNT(id) FROM destination";  
...
for ($i=1; $i<=$total_pages; $i++) {  
             $pagLink .= "<li><a href='destination.php?page=".$i."'>".$i."</a></li>";  
};  
echo $pagLink . "</ul></nav>";  
?>
...
$('.pagination').pagination({
		...
		hrefTextPrefix : 'destination.php?page='
    });
	});
	</script>
