...
$query="select * from international_inclusions where id='$e_id'";
        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <div class="col-md-12 member">
              <div class="form-group pb20 col-md-12"><h3 style="text-align:center;">Update Inclusions/Exclusions</h3></div>
<div class="col-md-12">
               <form name="image" action="update_international_inclusion.php" method="post" enctype="multipart/form-data">
                  <div class="col-md-12">
