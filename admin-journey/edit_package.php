...
$e_id=$_GET["e_id"];
$_SESSION=$_GET["e_id"];
$query1="Select * from package where id='$e_id'";
        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <div class="col-md-12 member" style="">
              <div class="pb20 col-md-12"><h2 style="text-align:center;">Edit Package Details</h2></div>
               <form name="image" action="update_package.php" method="post" enctype="multipart/form-data">
              ...
              <input type="text" class="form-control" name="city" value="<?php echo $city;?>" placeholder=" Enter City Name" required>
                 </div>
