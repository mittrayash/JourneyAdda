...
if(isset($_POST["submit"]))
{
    ...
    $about=$_POST["about"];
    $city=$_POST["city"];
       $query=mysqli_query($conn, "select * from international_package where id='$e_id'")or die(mysqli_error());
       ...
       if(!empty($_FILES["fileupload1"]["name"]))
	    ...
	    $query2="UPDATE international_package SET image='$fileupload2',package_name='$package',day='$day',night='$night',price='$price',about='$about',country='$city' where id=$e_id";
