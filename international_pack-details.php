...
$query="select * from international_package_details where package_name='$package'";
...
$query1="select * from international_package where package_name='$package'";
$row1=mysqli_query($conn,$query1);
$data1=mysqli_fetch_assoc($row1);
$price=$data1["price"];
$query2="select * from international_itinerary where package_name='$package'";
...
$query3="select * from international_attractions where package_name='$package'";
...
$query4="select * from international_inclusions where package_name='$package'";
...
$query5="select * from international_destination where package_name='$package'";
...
$p_query="select * from international_package where package_name='$package'";
...
<div class="container pt50 pb50">
	<div class="row">
		<h3 class="col-md-12" style="font-weight:700;">Other packages that may interest you</h3>
		 ...
		 <?php
		  $other="select * from international_package where status='1'";
		  $package=mysqli_query($conn,$other);
		  while($pack=mysqli_fetch_assoc($package))
		  {
		    $oimage='admin-journey/'.$pack["image"];
		    $opackage_name=$pack["package_name"];
		    $onight=$pack["night"];
		    $oday=$pack["day"];
		    $oprice=$pack["price"];
		    $oabout=$pack["about"];
		    $ocountry=$pack["country"];
